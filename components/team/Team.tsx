...
function Team({}: Props) {
  ...
  return (
    <div ref={container} className="min-h-screen  w-full p-4 my-[30vh]">
      ...
      <div className=" w-full grid md:grid-cols-2 gap-px">
        {/* left card */}
        <div className="box opacity-0 bg-background grid sm:grid-cols-2 hover:cursor-pointer my-4 sm:my-0">
          <div className="min-h-[60vh] bg-[#232328] relative">
            <Image src="/p2.jpg" fill alt="" className="object-cover" />
          </div>
          <div className="flex items-center justify-center flex-col p-4 space-y-4 min-h-[30vh]">
            {/* <div className=""> */}
            <H2 className="text-center uppercase">Joan Martinez</H2>
            <P className="text-center">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Eligendi, iste. Lorem ipsum dolor sit amet.
            </P>
        ...
        {/* left right */}
        <div className="box opacity-0 bg-background grid sm:grid-cols-2 hover:cursor-pointer my-4 sm:my-0">
          <div className="min-h-[60vh] bg-[#232328] md:col-start-1 relative sm:col-start-2 ">
            <Image src="/p1.jpg" fill alt="" className="object-cover" />
          </div>
          <div className="flex items-center sm:col-start-1 sm:row-start-1 md:col-start-2 justify-center flex-col p-4 space-y-4 min-h-[30vh]">
            {/* <div className=""> */}
            <H2 className="text-center uppercase">Kamila Hayes</H2>
            <P className="text-center">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Eligendi, iste. Lorem ipsum dolor sit amet.
            </P>
        ...
        <div className="box opacity-0 bg-background grid sm:grid-cols-2">
          <div className="flex items-center justify-center flex-col p-4 space-y-4">
            {/* <div className=""> */}
            <H2 className="text-center uppercase">NLayla Davis</H2>
            <P className="text-center">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Eligendi, iste. Lorem ipsum dolor sit amet.
            </P>
          ...
          <div className="h-[60vh] bg-[#232328] row-start-1 md:col-start-2 relative">
            <Image src="/p3.jpg" fill alt="" className="object-cover" />
          </div>
        </div>
        {/* bottom right */}
        <div className="box opacity-0 bg-background grid sm:grid-cols-2">
          <div className="flex items-center justify-center flex-col p-4 space-y-4">
            {/* <div className=""> */}
            <H2 className="text-center uppercase">Arjun Rao</H2>
            <P className="text-center">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Eligendi, iste. Lorem ipsum dolor sit amet.
            </P>
          ...
          <div className="h-[60vh] bg-[#232328] row-start-1 sm:col-start-2 relative">
            <Image src="/pixs.jpg" fill alt="" className="object-cover" />
          </div>
        </div>
      </div>
    </div>
